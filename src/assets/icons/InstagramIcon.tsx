...
export const InstagramIcon: React.FC<IconProps> = ({ width = 30, height = 30, color = '#ffffff' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width={width} height={height} viewBox="0,0,256,256" style={{ fill: color }}>
